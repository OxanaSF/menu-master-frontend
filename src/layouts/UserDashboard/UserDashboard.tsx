...
export const UserDashboard = () => {
  const [favoriteMenus, setFavoriteMenus] = useState([
    { id: 1, name: "Italian Night", description: "A classic Italian dinner menu" },
    { id: 2, name: "Taco Tuesday", description: "A fiesta of flavors with tacos and sides" },
    { id: 3, name: "Weekend Brunch", description: "A hearty brunch menu for lazy weekends" }
  ]);
